...
namespace Aplikacija.AllProducts.Corpus.EdgeTapes
{
    ...
    class EdgeTapeCorpusViewModel : ContainerViewModelBase, IEdgeTapeCorpusViewModel
    {
        #region Fields
        ...
        public Detail SelectedDetail
        {
            ...
            set
            {
                if (_selectedDetail != value)
                {
                    ...
                    if (_selectedDetail != null && _selectedDetail.EdgeTapeList.Length > 0)
                    {
        ...
        #region Constructors
        public EdgeTapeCorpusViewModel()
        {
        ...
        {
            if (_corpus != null)
                _corpus.AddEdgeTapes(SelectedDetail, _selectedEdgeTapeOne, _selectedEdgeTapeTwo, _selectedEdgeTapeThree, _selectedEdgeTapeFour);
        }
